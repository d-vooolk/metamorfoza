...
const getRecordsLayout = () => {
    ...
    for (let i = 0; i < maxRecords; i++) {
        recordsContainer.innerHTML += `
                <div class="record">
                    <img src="${baseImagesUrl}${recordsConfig[i]?.img}" alt="записи" class="record-img"/>
                    ...
                    <div class="social-icons-list-wrapper">
                        <a href="${recordsConfig[i]?.spotify}" target="_blank noopener noreferer" class="records-link">
                            <div class="record-in-social">
                                <img src="images/icons/spotify-color.svg" alt="spotyfy">
                                <div class="social-description">Spotyfy</div>
                            </div>
                        </a>
                        <a href="${recordsConfig[i]?.zvuk}" target="_blank noopener noreferer" class="records-link">
                            <div class="record-in-social">
                                <img src="images/icons/zvuk.svg" alt="zvuk">
                                <div class="social-description">Zvuk</div>
                            </div>
                        </a>
                        <a href="${recordsConfig[i]?.yandex}" target="_blank noopener noreferer" class="records-link">
                            <div class="record-in-social">
                                <img src="images/icons/yandex-music.svg" alt="yandex">
                                <div class="social-description">Yandex</div>
                            </div>
                        </a>
                        <a href="${recordsConfig[i]?.apple}" target="_blank noopener noreferer" class="records-link">
                            <div class="record-in-social">
                                <img src="images/icons/apple-music.svg" alt="apple">
                                <div class="social-description">Apple</div>
                            </div>
                        </a>
                        <a href="${recordsConfig[i]?.youtube}" target="_blank noopener noreferer" class="records-link">
                            <div class="record-in-social">
